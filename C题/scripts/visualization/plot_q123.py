...
OUT = PROJECT / "output" / "figures" / "q123"
Q1 = PROJECT / "output" / "results" / "q1"
Q2 = PROJECT / "output" / "results" / "q2"
Q3 = PROJECT / "output" / "results" / "q3"
...
def raw_q3() -> None:
    raw = pd.read_excel(PROJECT / "data" / "raw" / "附件.xlsx", sheet_name=0)
