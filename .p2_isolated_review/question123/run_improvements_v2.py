...
COMMANDS = [
    [r"E:\anaconda\envs\yolov_env\python.exe", "question3/extended_group_search_v3.py"],
    [r"E:\anaconda\envs\yolov_env\python.exe", "question4/patient_triage_v6.py"],
    [r"E:\anaconda\python.exe", "question2/policy_sensitivity_v11.py"],
    [r"E:\anaconda\python.exe", "question1/diagnostics_v2.py", "--repeats", "200"],
]
OUTPUT_DIRS = (
...
def main() -> None:
    ...
    manifest = {
        ...
        "unique_reproduction_command": r"E:\anaconda\python.exe question123\run_improvements_v2.py",
